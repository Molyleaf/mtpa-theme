...
function sakura_scripts()
{
    ...
    if (iro_opt('smoothscroll_option')) {
        wp_enqueue_script('SmoothScroll', 'https://s.nmxc.ltd/sakurairo/@2.7.1.1/js/smoothscroll.js', array(), true);
    }
}
